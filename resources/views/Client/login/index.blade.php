...
@section('content')
   <div class="flex-col justify-center items-center">
            ...
            <div class="max-w-xl mx-auto p-4 rounded-md bg-cyan-500 space-y-4">
                ...
                <form class="space-y-4" action="#" method= "POST">
                    ...
                    <div>
                        ...
                        <input class="w-full rounded-md px-2" id="email" type="text">
                    </div>
                    <div>
                        <label for="password">Password</label>
                        <input class="w-full rounded-md px-2" id="password" type="text">
                    </div>
       ...
       <div id="register" class="hidden">
            <div id="register" class="max-w-xl mx-auto p-4 bg-cyan-500 space-y-4">
                <p class="text-2xl text-center font-semibold">Register</p>
                <form class="space-y-4" action="" method= "POST">
                    @csrf
                    <div>
                        <label for="name">Name</label>
                        <input class="w-full rounded-md px-2" id="name" type="text">
                    </div>
                    <div>
                        <label for="email">Email</label>
                        <input class="w-full rounded-md px-2" id="email" type="text">
